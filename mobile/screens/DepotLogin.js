...
export default function DepotLogin({ navigation }) {
  ...
  const handleLogin = () => {
    ...
    if (depotId && location) {
      navigation.replace("DepotHome"); // create DepotHomeScreen later
    } else {
      alert("Please enter your Depot ID and location.");
    }
  };
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        {/* Screen Title */}
        <Text style={styles.title}>Depot Login</Text>
        ...
        <View style={[styles.formContainer, width > 768 && styles.desktopFormContainer]}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Depot Location (e.g., Zomba)"
            placeholderTextColor={styles.placeholder.color}
            value={location}
...
const getStyles = (isDarkMode) => {
  const theme = {
    ...
    primary: "#ff6f00",
    depotColor: "#1e90ff", // Blue for depot role
  };
  ...
  return StyleSheet.create({
    ...
    loginButton: {
      backgroundColor: theme.depotColor,
      padding: 16,
      borderRadius: 10,
      width: "100%",
      alignItems: "center",
